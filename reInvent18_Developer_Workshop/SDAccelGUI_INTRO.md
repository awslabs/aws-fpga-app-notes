...
The default GUI perspective includes the following sections:
 ...
 Refer to the SDAccel Environment User Guide ([UG1023](https://www.xilinx.com/cgi-bin/docs/rdoc?v=2018.2;d=ug1023-sdaccel-environment-user-guide.pdf)) for more information on the features of the SDx IDE.
...
* In the **Assistant** window, expand **Emulation-SW** and then **Test-Default**. Double-click **Application Timeline** to open it. This shows a timeline of the OpenCL API calls, data transfers and kernel executions.
